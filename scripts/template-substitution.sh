...
environment_variables="A7_AUTOINDEX A7_AUTOINDEX_CORS_ALL A7_ZIP_DIRECTORIES A7_META_QUERIES A7_META_QUERIES_CORS_ALL A7_CORS_ALL A7_PATH_AUTO_EXPAND A7_GET_REQUESTS_ONLY A7_INTERNAL_API A7_TITLE A7_ICON"
